...
\BI
\item Today, 4-8, Physics 208
\item Tomorrow, 10-3, Physics 106 
\item Friday, 10-4, Link 114 
\BI
\item Note: I am sick and have to sing a concert this weekend. If my voice gives out this review may be led by someone else or rescheduled; I'll do my best!
\EI
\item This is a large amount of extra help for you -- please use it!
\EI
\BS
\BS
Homework 9 due today; no late penalties until Thursday.

\BS

If you forgot to turn in your paper, get on that :)
}
...
\frame{\frametitle{\textbf{Final exam format}}
  \Large
\BI
\item Biased toward Units 3 (conservation laws) and 4 (torque)
\item Expect a focus on broad concepts, especially from Units 1 and 2
\item Expect things like:
\BI
\large
\item Sometimes/always/never questions
\item Positive/negative/zero questions
\item ``I give you the solution; you point out the error''
\item Dimensional analysis/reasoning with units
\item Fermi problem
\EI
\pause\BS
\item We will provide you the reference sheet for the exam; if there's anything you want on it, let me know!
\EI
}
...
\frame{\frametitle{\textbf{And, finally...}}
  \Large
... thank you all; you have been an absolutely wonderful class. You've done challenging things, learned a vast 
amount, and I'm proud of all of you.
