...
\BI
\large
\item Group Exam 3 tomorrow; Exam 3 next Tuesday
\item Review notes posted on the website
\item{Extra homework help hours today: 9:45-10:45}
\item HW7 due Friday
...
\frame{\frametitle{\textbf{Extra exam review session}}
	Extra exam review session will be held {\bf Monday afternoon or evening}. We are still getting a time/place. (I am sadly booked all weekend.)
	
	
	\BS
	
	This will be a little more scripted than the last one, but I expect it should prepare everyone for the exam -- instead of ``cramming'' on your own, come work with us.
	
	
	\BS
	
	To get the maximum benefit out of this, you should:
	
	\BI
	\item Have done all your homework
	\item Go to the Physics Clinic after the group exam Friday and ask the coaches to help you with anything you couldn't do
	\item Be familiar with most of the recitation exercises we have done
	\item Have already attempted the practice exam over the weekend, and have looked at the solutions (posted Friday or Saturday)
	\EI
...
Shall we talk about the ``one with the truck''?
...
We have met two of them: {\it conservation of momentum} and the {\it work-energy theorem}.
