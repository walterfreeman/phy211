...
\frame{\frametitle{\textbf{Announcements}}
	...
	\begin{itemize}
		\item Today, 3:00-5:00 (probably -- see next slide)
		\item Tomorrow, 2:00-4:00 
		\item Thursday, 2:00-4:00
		\item Sunday, 2:00-5:00 PM, Stolkin Auditorium -- a review for Exam 2
	\end{itemize}
}
	...
	\frame{\frametitle{\textbf{Exam 2 approaches}}
		\Large
		\BI
		\item Group Exam 2 is Thursday/Friday in recitation
		\item Exam 2 is next Tuesday
		\BI
		\item More details about Exam 2 on Thursday
		\EI
		\EI
...
I'm sick with something. I don't know what, but it's not COVID (per antigen test).

\bigskip\bigskip

I can't talk over a bunch of noise today in class. I will project as much as I can, but please be patient with me. :(

\bigskip\bigskip

I may not be able to hold Clinic hours today. If I can't, I will be available on Discord / email from 3-5pm to help 
people with homework.

\bigskip\bigskip

This also means I'm behind on some other stuff I need to do. 
}
...
\frame{\frametitle{\textbf{An exam question from 2021: a Formula 1 car}}
	
	Formula 1 cars are designed so that the air going over them creates extra aerodynamic forces on them that press them into the ground. 
	...
	Let's look at the 2021 exam question...
}
...
\large
\bigskip
\item $M$ and $m$ are the masses of the two objects (Sun and Earth, Earth and person, etc.)
...
\frame{\frametitle{\textbf{Gravity and circular motion}}
  ...
  \begin{itemize}
    ...
    \item{Everything you learned last week about uniform circular motion still applies}
...
\frame{\frametitle{\textbf{Weighing the Moon...}}}
