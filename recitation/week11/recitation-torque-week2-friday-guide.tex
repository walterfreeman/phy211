...
{\color{red}The power is $P_{\rm rot} = \tau \omega = 5000 W$. This is ``full power'' -- the maximum power the motor can deliver.}
...
{\color{red}If $\omega$ is limited to 25 rad/s (half speed), then the power will only be half as much: $P = 100~\rm N \cdot \rm m \times 25~{\rm{rad}/{\rm s}}2500 W}
