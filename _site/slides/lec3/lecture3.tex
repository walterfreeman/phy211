...
``Why does gravity make all objects fall at the same rate, in light of Newton's second law?''

\BS\BS\pause

Newton's second law: {\color{Red} \bf ``It takes more force to make more massive things accelerate''}

\BS\BS\pause

We should look at this backwards: {\bf \color{Blue} We observe that all objects fall at the same rate. What must the law of gravity be to make this happen?}\BS\BS\pause

The law of gravity: {\color{Green} \bf ``Gravity applies more force to more massive things''}
