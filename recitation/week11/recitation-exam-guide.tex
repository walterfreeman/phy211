...
\begin{document}
\Large
\centerline{\sc{Recitation - Exam 3 Guide}}
\normalsize
\centerline{\sc{Week 11 Day 2}}
...
%%
%%\item Newton's third law applies to the forces that the two gears exert on each other: the teeth of the two gears push on each other with equal and opposite forces. Given this, determine the relationship between $\tau_{\rm {motor}}$ (the torque the motor applies to the red gear) and $\tau_{\rm {machine}}$ (the torque the blue gear applies to the machine) in terms of $r_{in}$ and $R_{out}$. Record this formula on the back page.
%%
%%\vspace{2in}
%%
