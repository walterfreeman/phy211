...
\frame{\frametitle{\textbf{Announcements}}
	\large
	\BI
	\item Homework 8 is due Friday in recitation. It consists of a redo of Exam 3, along with two other problems which are posted.
	\BI
	\item The best places to ask for help here are the Physics Clinic and the course Discord server
	\item The Discord has a temporary verification process in place (see announcement by email)
	\item If you email Walter physics questions, they are highest priority
	\EI\pause
	\BS\BS
	
	\item You should get your exams back in recitation tomorrow
	\BI
	\item If you don't (some of our teaching staff is out sick too), you will Friday
	\item You should see your grades on Blackboard ASAP
	\EI
	
	\pause
	\BS\BS
	\item Walter is still recovering and hopes to be back Thursday
	\item He won't know until Wednesday night per CDC guidelines
	\EI
