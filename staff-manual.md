...
We'll all be working closely together this semester (professors, TA's, coaches, and students), and it's vitally important that we do this in a supportive, collegial, positive way. This is always true, but it is even more crucial as we return to a rigorous and "down-to-business" approach after the pandemic,
while simultaneously dealing with Omicron.

GTA's and coaches are *junior professional instructors*, not minions. You all will have your own ideas about how best to run things in your own recitations. That's fantastic: as teaching professionals in your own right, you *should* have your own ideas and act on them.
...
challenges -- please ask. We will have sufficient staff that we can get you reinforcements and flexibility if you need them.
...
or other things happening in your life), please let me know. *We will help you* -- I have gone to the mat to support physics coaches/TA's who need help and I'll do it again if you need anything.
...
are not able to get enough sleep, etc., please let me or the head TA know. We will get coverage for you during your
section, get you some backup in grading, or whatever it is that you need. I can't emphasize this enough: 
...
On the first day of class, have the students self-sort into groups of three. These groups should be pretty persistent from section to section, but if there are complaints, some fluidity is fine. It can be
better if students from minoritized groups (women/nonbinary folks, minoritized races) work with other people who share their identity if possible, but if they find other groupmates,
this is fine too.
...
Since our objective is for students to gain confidence and skill in figuring things out for themselves, 
they should spend most of their time actively working with each other. 
...
Each day, you should keep a log of your students' attendance and participation.

* 0/3: absent, or present and not contributing, for most of recitation
* 1/3: participating marginally, or absent for much of class
* 2/3: working but without full engagement with their group
* 3/3: working together to learn physics with their group 
...
However, even though the coaches will often be better instructors than we are, we generally know more physics than they do. Part of your job is to serve as an "expert in the room"; if the coaches are presenting things to students in a way that is confusing or incorrect, you will have the background needed to clarify things. Generally the coaches are excellent, but if you encounter a situation where a coach is regularly unprepared or leading students astray, please let me know so I can steer things back on course.
...
Homework in this class is purely traditional (i.e. long-answer questions). They will submit 
homework to you in recitation.
...
* 9: solution mostly correct, but has minor flaws in the solution or its explanation that do not reflect a deficiency in physics knowledge
* **8: a fully correct solution that is not explained well** (see below)
...
Note that even a fully correct solution that isn't explained well can get no higher than 8/10. 
To count as "well explained", someone who doesn't already know the solution must be able to 
look at the student's work and clearly see what they are doing and understand why. Most commonly
this explanation will take the form of words combined with algebra; in some cases extremely 
well-organized algebra with descriptive names can be self-explanatory.

Keep in mind that in this class, the breakpoints between A/B/C/D/F are 80/65/55/50.

You should deduct significant credit for solutions that have numbers substituted in for variables too early (so they consist of lines of arithmetic that makes little narrative sense rather than algebra that shows what the student is doing and thinking), even if the final answer is correct.
...
We will create a column in Blackboard for students' recitation numbers. When entering grades,
you may sort Blackboard by recitation number; this will let you You are responsible for grading your students' homework and tracking their recitation participation. 
...
We will have three midterm mini-exams and a final.

We'll need proctors on those days in class to answer student questions (who may be TA's or coaches). During the final we'll need everyone or nearly everyone to help proctor. 
