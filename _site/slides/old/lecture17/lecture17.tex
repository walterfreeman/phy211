...
\BI
\item{Your next homework assignment is due Friday. The following one will be due next Friday.}
\item{Exam 2 retake is on Tuesday}
\item{Angular momentum didn't appear on the last exam, but it might this time!}
\item{If your exam was misgraded, grade appeals will be handled the same way as before (and faster!)}
\item{Students who were in recitation sections M011, M023, or M024 with Kehu Su but transferred out: please email me}
\item{Did you lose a black Adidas backpack in Stolkin at a student government event? I have it; come see me}
\EI
}
...
\centerline{\includegraphics[width=0.5\textwidth]{exam2histo-crop.pdf}}
    \Large
    \centerline{Average grade: 65}
    \centerline{You'll have a retake opportunity next Tuesday}
    \centerline{Exam 2 Retake study session: Sunday in Stolkin, 6:30-9:30}
  }
