...
\large
\BI
\item Homework 8 is due Friday
\item ``Second chance'' homework assignments posted on the webpage
\item You can find the help hours schedule there (there's a lot of them coming up)
\EI
}
%
...
Why does a Yo-Yo fall so slowly?
...
\frame{
	...
	\BC
	How many of you have played pinball?
	\EC
	\bigskip
	...
	You are trying to design a pinball machine's spring-loaded launcher. Suppose that:
	
	\BI
	\item The pinball has mass $m$ and radius $r$
	\item The machine is angled at an angle $\theta$ and has length $L$
	\item You want the ball to reach the top of the machine at a speed $v_T$
	\EI
	
	\BS
	
	You know the player will draw the spring-loaded launcher back a distance $d$. What spring constant should it have so the ball is traveling at $v_f$ at the top of the ramp??
}
...
\frame{
	...
	\BC
	\Large
	What kinds of energy does the system have initially?
	\EC	\bigskip
	
	\Large
	
	
	\color{A}A: elastic potential energy\\
	\color{B}B: gravitational potential energy\\
	\color{C}C: translational kinetic energy\\
	\color{D}D: rotational kinetic energy\\
	\color{E}E: None of the above, or so many I can't display them
...
\frame{
	...
	\BC
	\Large
	What kinds of energy does the system have at the top of the ramp?
	\EC
	...
	\color{C}C: translational kinetic energy\\
	\color{D}D: rotational kinetic energy\\
	\color{E}E: None of the above, or so many I can't show you...
...
\frame{
	...
	\BC
	\Large
	How do I handle this ``one equation, two unknowns'' problem?
	\EC
