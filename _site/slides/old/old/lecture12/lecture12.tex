...
\BI
\large
\item{Exams (+ regrades) will be returned tomorrow in recitation}
\item{If you didn't get your exam 1 back, email me}
\item{Exam average etc. will be posted once I have it}
  \BI
\item{The average of the 65 grades from one TA is 66/100; remember this can be no worse than a B-}
  \EI
\item{Next homework will be short, posted Friday, and due Friday after break}
\item{Next Mastering Physics will be short, posted Friday, and due before class Tuesday}
\EI
...
\normalsize
\centerline{\color{Blue}(If physics stops working and I go splat, have a nice spring break!)}
}
