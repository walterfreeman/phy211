...
\BI
\large
\item{Exams will be returned tomorrow or Friday in recitation}
\item{Exam stats etc. will be posted once I have them all}
\item{Next homework is posted and is due next Friday}
\item{Physics practice will return next week}
\EI
}
...
\Large
\BC
All the stats aren't in yet; I only have 200 out of around 500 grades.
\pause

\BS

The scores I have look quite good (average around 74, which is a high B).
This will likely go up a bit. I'll give you the full stats on Thursday.

\pause
\BS

Since the three forms may have been of uneven difficulty, I'll be 
rescaling Wed/Fri to match Thursday (but only upward).
\EC
...
\large
Today we'll study something new: energy.
...
\item Just as with momentum, forces transfer energy from one object (and one form) to another, but don't create or destroy it

\item Unlike momentum, energy is a scalar, not a vector

\item Energy methods are extremely powerful in problems where we \it \color{Red}don't know and don't care about time
