...
\author[W. Freeman] {Physics 211\\Syracuse University, Spring 2023\\Walter Freeman}
...
Come say hi; I and the teaching staff monitor this server and can provide assistance
...
\frame{\frametitle{\textbf{What's this?}}
	
	\begin{center}
	\includegraphics[width=0.8\textwidth]{orbitals.png}
	\BS\BS
	
	By the end of the semester, we'll be able to explain the atomic orbitals
	from your high school chemistry class using Newton's laws (and some drums)...
\end{center}
}
...
This will serve you well in whatever field you pursue!
...
\pause
\item {\color{Red}...the class meeting really exists to get you ready for recitation and debrief it afterwards}
\pause
\EI
\BS
\Large
...
\item We'll have teaching staff around to help you
...
\BI
\item{\color{Blue}... learn to look at moving things around you in a new, rigorous way}
\pause
\item{\color{Red}... learn to solve problems by taking them apart, understanding the parts, and putting them back together again}
\pause
\item{\color{Green}... learn to translate between and combine verbal, visual, and mathematical descriptions of things, while still being precise}
\pause
\EI
...
\item {Talk to me, your peers, and the teaching staff on the Discord server}
\pause
...
\frame{\frametitle{\textbf{The focused assistance program}}
We've designed a curriculum that most students learn most things well from.

\bigskip\pause

But not everyone's process through learning physics is the same!

\BI
\item Different people figure out different things at different rates \pause
\item People have differences in their math skills coming in
\EI

\bigskip\pause

I am working with Brendan Parlee to design a ``focused assistance'' program for this course.
\BS

This semester, we will:

\BI
\item Check in with you at the beginning to see your math background ({\color{Blue} \bf Homework 0})
\item {\color{Green} Offer assistance to students for specific math skills (trig, etc.)}
\item Keep track of how you're doing beyond just your grades 
\item {\color{Green} Offer assistance to students who don't master specific things at first}
\item Offer students another chance to earn credit once they learn those things
\item {\color{Red} Half of the final exam will be extra credit} for things you missed
\EI
\pause
\bf \color{Blue}
This is new this semester, so we welcome your help in designing it!
}

\frame{

\begin{center}
	\includegraphics[width=0.8\textwidth]{growth-mindset-meme.jpg}
\end{center}
...
{\color{Red}This week I'll be in the Physics Clinic today from 2:30-3:30pm and Friday 9-11am.}
...
In spring 2021 the course Discord server was home to a nearly 24-hour 
conversation, with students getting help from me, the GTA's and coaches, and each other.

\BS

It also became a social space, and many students found that
their classmates are awesome folks.
...
\EC
\pause
Many of us still use it; if you want to hang out with classmates or get homework help,
...
{\bf \color{Red} Where is the object I'm talking about?}
...
\large
Use a ``number line'' marked in meters:
\BI
\normalsize
\item{Choose one position to be the origin (``zero'')}
\item{Choose one direction to be positive}
\item{Measure everything relative to that}
\item{Can measure in any convenient units}
\EI
...
\column{0.4\textwidth}
\begin{center}
\includegraphics[width=0.8\textwidth]{metric-sign.jpg}\\

\scriptsize \it Yvonne Gonzales / Cronkite News Service
\end{center}
