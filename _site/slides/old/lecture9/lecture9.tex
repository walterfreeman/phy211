...
\BI
\Large
\item{Homework 4 due next Friday}
\item{It's a long one -- start early!}
\item{Read Chapter 8}
\EI

}

\frame{\frametitle{\textbf{Exam 1 recap:}}
\BI
\Large
\item{Averages on physics exams are generally around 65\%}
\item{This may seem low, but we ask more of you:}
\BI
\large
\item{We're not just asking you to repeat information or follow steps}
\item{... we're asking you to think on your feet and solve problems}
\EI
\item{The average on the first pass on Exam 1 was 65\%}
\item{The retake improved this to 69\%}
\pause
\item{My exams (especially the second one) were more difficult than the norm}
\item{... many of you did very well, and I'm proud of you!}
\EI
}

\frame{\frametitle{\textbf{Exam 1 recap:}}
\centerline{\includegraphics[width=0.6\textwidth]{exam1histo-crop.pdf}}

\pause

\BI
\item{If you didn't do as well as you had hoped on either exam...}
\item{... remember you can drop the lowest of your three exam scores.}
\EI
}
...
\frame{\frametitle{\textbf{Rotational motion: a reminder}}
  \begin{itemize}
...
\pause
  ...
  \Large
\centerline{$\theta = \omega t  \color{Grey} + \frac{1}{2}\alpha t^2$}
\large
...
\begin{itemize}
  \item{Angular velocity tells you how fast something spins}
...
\frame{\frametitle{\textbf{Clicker questions}}
\large
What does the force diagram on the water look like while the bucket is at the bottom?

\BI
\item{A: acceleration upward, normal force upward, gravity downward}
\item{B: centripetal force upward, normal force upward, gravity downward}
\item{C: gravity downward, normal force upward}
\item{D: gravity downward, velocity to the left, normal force upward}
\EI
}
...
\BI
\item{A: It {\it is} falling, but the bucket falls along with it, so it stays in}
\item{B: The normal force pushes it up} 
\item{C: The centripetal force pushes it up}
\pause
\item{D: Mr. Sampere is in the back chanting ``wingardium leviosa!''}
\EI
}
...
\BI
\item{A: acceleration downward, normal force upward, gravity downward}
\item{B: normal force upward, gravity downward}
\item{C: gravity downward, normal force downward}
\item{D: normal force downward, gravity downward, centrifugal force upward} 
\EI
}
