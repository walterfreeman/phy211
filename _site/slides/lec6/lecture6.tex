...
\item{If you must miss Friday, notify your TA in advance and explain to them why you will be absent; be prepared to provide documentation}
...
\frame{\frametitle{\textbf{Exam 1, protocol}}
	...
	\item Some seats are left-handed; we'll ask you which hand you write with on Friday's checkin
...
\frame{\frametitle{\textbf{Monkey and coconut (modified from ``monkey and hunter'')}}
	
	\large
	A monkey is hanging from a tree branch and is carrying a coconut. A human walks by, and the monkey throws it at them.
	
	\pause\bigskip
	
	They pick up the coconut and throw it back at the monkey. Not understanding gravity, they aim the coconut directly at the monkey. (This means that $\vec v_0$ is pointed directly at the monkey.)
	
	\pause\bigskip
	
	The monkey, being a clever sort and not wanting to get hit by the coconut, lets go of the tree branch as soon as the human releases the coconut; it hopes to fall to the ground and let the coconut fly over its head.
	
	\pause\bigskip
	
	Will the monkey dodge the coconut by doing this, or will the coconut return to monke?
}



\frame{\frametitle{\textbf{Kicking a football from a cliff}}
	We return to our example football player from last class. They kick a football from the top of a 10-meter-tall cliff at 20 m/s at an angle $30^\circ$ above the horizontal. Where does it land?
}
