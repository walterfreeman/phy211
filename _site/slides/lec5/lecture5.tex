...
\item{Physics practice: tomorrow night, 7:30-9:30, here}
\BI
\item{Topic: ``setting up problems'', i.e. the actual physics}
\EI
\item{Recitation tomorrow has an extra credit question}
...
\frame{\frametitle{\textbf{Exam 1}}
 ...
 \item{\color{Red}The exam will be somewhat easier than the homework.}
   \pause
 \item{You may use any ordinary calculator or graphing calculator on the exam, but no cellphones or computers, or Ti N-spire level devices}
...
\large
\BI
\item{A cannon shoots a cannonball at initial velocity $v_0=80 m/s$ at an angle $\theta=30^\circ$ above the horizontal.}
\item{If the cannon is on level ground, how far does the cannonball go?}
  \pause
\item{How high does the cannonball go?}
\pause
...
\large
\BI
\item What changes if I put the cannon up on a hill?
\pause
\item What changes if I'm trying to hit a target up on a plateau?
\pause
\item What changes if I want to know what velocity I need to hit a target? 
\pause
