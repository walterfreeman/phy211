...
\BI
\item Tuesday, 9:45-10:30 (Walter), possibly 5:00-6:00 (Walter)
\item Wednesday, 1:30-3:30 (Nada); 3:30-5:00 (Walter); 6:00-8:00 (Mac)
\item Thursday, 9:45-10:30 (Walter); 3:00-5:00 (Walter, Adam P.)
\EI
\item Homework 5 will be shorter, assigned this Thursday, due next Wednesday
\item Group Exam 2 next Wednesday
\item Exam 2 next Thursday
\item No recitation next Friday (Spring Break)
\EI
}
