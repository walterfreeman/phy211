...
\begin{flushright}
	--Rosalind Franklin, English biophysicist, to her father
\end{flushright}
...
\BI
\item Homework 1 due during your next recitation
\BI
\item People in Thursday recitations: you can turn it in on Friday {\it if you are at recitation Thursday}
\item To do this, go to recitation Thursday and turn in a piece of paper with your name and a note that says ``I'll turn this in to your mailbox Friday''
\EI

\item{Homework 2 will be posted late today}
\item{The Clinic got a lot of use yesterday}
\item I'll be in the Physics Clinic today 1:30-3:00pm

\bigskip

%\item We'll have coaches on duty on Discord 8pm-midnight tonight
\item{Homework 2 due next Friday, posted later today}
\item{Next week:}
\BI
\item {Tuesday and Thursday we will be applying and practicing what we learn today}
\item {Group practice test in your recitation Thursday/Friday}
\EI
\EI
}
...
\begin{center}
{{\color{Red}\bf Caution:} this is much easier than doing stuff involving the ``law of cosines'' or ``law of sines''. This is not one of those obnoxious problems from high school geometry; down that path lies madness.}
\end{center}
}
