...
\frame{
\includegraphics[height=\textheight]{nomnomnom.pdf}
}

\frame{\frametitle{\textbf{Announcements}}
\BI
\item{Your next homework assignment is due next Friday.}
\item{I'm aware ODS students have not had their exams graded yet -- I will rectify this ASAP}
\item{Physics practice will return next Wednesday}
\EI
}
