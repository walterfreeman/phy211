...
\item{Course organization / syllabus /navigating the online world}
...
\frame{\frametitle{\textbf{What is physics?}}
}
...
\includegraphics[width=0.18\textwidth]{sun.jpg}
\includegraphics[width=0.18\textwidth]{rocket.jpg}
\includegraphics[width=0.18\textwidth]{crab-nebula.jpg}\\
\includegraphics[width=0.18\textwidth]{lightning.jpg}
\includegraphics[width=0.18\textwidth]{snowflake.jpg}
\includegraphics[width=0.18\textwidth]{hurricane.jpg}\\
...
... and tend to manifest {\it similar patterns} that can be understood in {\it similar ways}.
\end{center}
}
...
\begin{center}
\Large {\color{Blue} ``Objects accelerate when pushed by forces; they accelerate in the direction of the force, proportional to the size of the force, but inversely proportional to their mass.''}
\end{center}
\normalsize
...
\begin{columns}
	\column{0.5\textwidth}
	\begin{flushright}
		--Crystal Bailey, APS Careers 2020
	\end{flushright}
	\column{0.5\textwidth}
	\begin{flushright}
		--Kate Kirby, APS Careers 2020
	\end{flushright}
\end{columns}
...
%\item ``Where have I seen this pattern before?''
%\end{itemize}
%\pause
%\bigskip
%
...
\centerline{\includegraphics[width=0.8\textwidth]{andromeda.jpg}}
}
...
\pause
\item{\href{https://www.youtube.com/watch?v=PWKuMD0rrFA}{... but a computer can do it!}}
\end{itemize}
}
...
\item {\color{Red}Rotational energy and angular momentum}
\end{itemize}
\item Two more mechanics topics
\BI
\item {\color{Red} How forces cause torques, and rotation in more detail}
...
\frame{\frametitle{\textbf{The process of science}}
	...
	We'll study what science is, what it's not, and how you can protect yourself \\from \sout{bullshit} \pause \sout{``alternative facts''} \pause flawed scientific reasoning.
}
%
...
\frame{\frametitle{\textbf{Components of this course}}

	\small
	\BI
	\item {\bf Lecture:} Held on Zoom and Twitch Tuesday/Thursday. Please contribute your comments as we go! 
	\item {\bf Recitation:} Held on Blackboard Collaborate or in person Wednesday/Friday. The most important part of the course!
	\item {\bf My office hours:} Held on the same Zoom link as class, Tuesday 1:30-4:30 and Friday 9:30-12.
	\item {\bf TAs' office hours:} Location/time TBD.
	\EI
\BS
Tools everyone will want to use:
\BI
\item {\bf Zoom:} -- for lecture and office hours
\item {\bf Blackboard:} -- you will turn in assignments on Blackboard. Announcements also posted here.
\item {\bf Course website:} -- \url{walterfreeman.github.io/phy211/}: you can find materials and announcements here, and links to everything
\item {\bf Blackboard Collaborate:} -- for online recitations
\EI

\BS
Optional tools that may make your life easier:

\BI
\item {\bf Twitch:} -- a less-clunky way to participate in lecture (accounts are free)
\item {\bf Discord:} -- a popular chat program; the course has a Discord server (invite on the webpage)
\EI
...
\url{https://walterfreeman.github.io/phy211/syllabus.html}
}
...
\item{You will be assigned groups, work together for a whole unit, and then have a ``group exam''}
...
\frame{\frametitle{\textbf{The course webpage}}
				...
				\large
		Since Blackboard is so clunky, I maintain a separate website:
		\begin{center}
			\url{https://walterfreeman.github.io/phy211/}
		\end{center}
		
		I will post announcements, homework assignments, and recitation materials there.
		
		\BS
		
		I will also post announcements to Blackboard and send them out by email.
		
		\BS
		
		I will {\it sometimes} post slides. Other times everything will be on the chalkboard, so we won't have slides.
		
		\BS
		
		The best reference for class is your own notes.
		
		\BS
		
		The second-best reference is the video recording of class -- you can get it on Twitch or YouTube.
...
%\large
%\BI
%\item{Interrupt us in class and ask questions}
%\item{Ask us questions by email}
%\BI
%\normalsize
...
%\bigskip
%
%We also hold help hours there:
%
%\BI
%\item Walter: 2-4 Tuesday, 9:30-11:30 Friday (but not this Friday), others TBA
%\item Matt: 2-4 Friday, others TBA?
%\EI
%\bigskip
%
...
%
%\Large
%You're also always free to drop by our offices:
%
%\BI
%\item Walter: Physics 215 (the one with the birds on the door)
%\item Matt: Physics 325 (no birds, sorry)
%\EI
%
%\bigskip
%
%We might not be there, and we might have other urgent stuff to do, but helping students learn is a very high priority, so 
%if I'm around, likely I can drop whatever I'm doing and help you with physics.
%
%}
\setbeamercolor{background canvas}{bg=Key}
\frame{\frametitle{\textbf{Dimensions: what kinds of things do we measure?}}}
%\large
...
\setbeamercolor{background canvas}{bg=Key}
\frame{\frametitle{\textbf{``It is two hours from Syracuse to Adirondack State Park''}}
%\Large
%
%
%
...
\setbeamercolor{background canvas}{bg=Key}
\frame{\frametitle{\textbf{Math and the real world}}
%
%\Large
%
%\BC
...
\frame{\frametitle{\textbf{Algebra with units: velocity}}
%
%\large
...
\frame{\frametitle{\large \textbf{``A falling rock's speed increases by 10 meters per second every second.''}}
%\BC
%\large
%
%
...
\frame{\frametitle{\textbf{What units might we measure {\it force} in?}}
%
